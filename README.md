...
- AI integration enables users to automatically generate summaries of catalog materials.

- The project is available in two versions: one Express-based traditional server architecture, another optimized for serverless edge rendering via Cloudflare Workers.

### Built with:

Hono, Express, Node.js, Handlebars, Bootstrap, PostgreSQL.

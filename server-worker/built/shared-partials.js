...
Handlebars.partials['book_form_body'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <div class=\"row mb-3\">\n        <label for=\"select-author-id\" class=\"col-form-label col-sm-3 required-star\">Author</label>\n        <div class=\"col d-flex gap-1\">\n            <div class=\"input-group-has-validation flex-grow-1\">\n                <select name=\"author_id\" id=\"select-author-id\" class=\"form-select "
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(lookupProperty(helpers,"error-check")||(depth0 && lookupProperty(depth0,"error-check"))||alias2).call(alias1,(depth0 != null ? lookupProperty(depth0,"trouble") : depth0),"author_id",{"name":"error-check","hash":{},"data":data,"loc":{"start":{"line":19,"column":88},"end":{"line":19,"column":121}}}),{"name":"if","hash":{},"fn":container.program(3, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":19,"column":82},"end":{"line":19,"column":140}}})) != null ? stack1 : "")
    + "\">\n                    <option value=\"-1\">Select author...</option>\n"
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,(depth0 != null ? lookupProperty(depth0,"authors") : depth0),{"name":"each","hash":{},"fn":container.program(6, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":21,"column":20},"end":{"line":23,"column":29}}})) != null ? stack1 : "")
    + "                </select>\n                <div class=\"invalid-feedback w-100\">"
    + container.escapeExpression((lookupProperty(helpers,"error-check")||(depth0 && lookupProperty(depth0,"error-check"))||alias2).call(alias1,(depth0 != null ? lookupProperty(depth0,"trouble") : depth0),"author_id",{"name":"error-check","hash":{},"data":data,"loc":{"start":{"line":25,"column":52},"end":{"line":25,"column":87}}}))
    + "</div>\n            </div>\n            <a class=\"btn ui-button\" href=\"/catalog/author/import\" style=\"width: 36px; height: 36px;\"><img src=\"/file-earmark-plus.svg\" alt=\"New entry icon. Click to import an author.\"></a>\n        </div>\n    </div>\n";
  ...
  return "                    <option value=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"author_id") || (depth0 != null ? lookupProperty(depth0,"author_id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"author_id","hash":{},"data":data,"loc":{"start":{"line":22,"column":35},"end":{"line":22,"column":48}}}) : helper)))
    + "\" "
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(lookupProperty(helpers,"match-string")||(depth0 && lookupProperty(depth0,"match-string"))||alias2).call(alias1,((stack1 = (depths[1] != null ? lookupProperty(depths[1],"populate") : depths[1])) != null ? lookupProperty(stack1,"author_id") : stack1),(depth0 != null ? lookupProperty(depth0,"author_id") : depth0),{"name":"match-string","hash":{},"data":data,"loc":{"start":{"line":22,"column":56},"end":{"line":22,"column":102}}}),{"name":"if","hash":{},"fn":container.program(7, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":22,"column":50},"end":{"line":22,"column":119}}})) != null ? stack1 : "")
    + ">"
    + alias4(((helper = (helper = lookupProperty(helpers,"last_name") || (depth0 != null ? lookupProperty(depth0,"last_name") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"last_name","hash":{},"data":data,"loc":{"start":{"line":22,"column":120},"end":{"line":22,"column":133}}}) : helper)))
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"last_name") : depth0),{"name":"if","hash":{},"fn":container.program(9, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":22,"column":133},"end":{"line":22,"column":159}}})) != null ? stack1 : "")
    + alias4(((helper = (helper = lookupProperty(helpers,"first_name") || (depth0 != null ? lookupProperty(depth0,"first_name") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"first_name","hash":{},"data":data,"loc":{"start":{"line":22,"column":159},"end":{"line":22,"column":173}}}) : helper)))
    + "</option>\n";
},"7":function(container,depth0,helpers,partials,data) {
    return "selected";
  ...
  return "    <div class=\"row mb-3\">\n        <label for=\"genre-checkboxes\" class=\"col-form-label col-sm-3\">Suggestions</label>\n        <div class=\"col d-flex flex-wrap justify-content-between\">\n"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"suggestions") : depth0),{"name":"each","hash":{},"fn":container.program(14, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":60,"column":12},"end":{"line":65,"column":21}}})) != null ? stack1 : "")
    + "        </div>\n    </div>\n";
  ...
  return "            <div class=\"form-check min-tiny w-100\">\n                <input type=\"checkbox\" class=\"form-check-input\" name=\"suggestion-"
    + alias4(((helper = (helper = lookupProperty(helpers,"suggestion_id") || (depth0 != null ? lookupProperty(depth0,"suggestion_id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"suggestion_id","hash":{},"data":data,"loc":{"start":{"line":62,"column":81},"end":{"line":62,"column":98}}}) : helper)))
    + "\" id=\"scb-"
    + alias4(((helper = (helper = lookupProperty(helpers,"suggestion_id") || (depth0 != null ? lookupProperty(depth0,"suggestion_id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"suggestion_id","hash":{},"data":data,"loc":{"start":{"line":62,"column":108},"end":{"line":62,"column":125}}}) : helper)))
    + "\" value=\""
    + alias4(((helper = (helper = lookupProperty(helpers,"name") || (depth0 != null ? lookupProperty(depth0,"name") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data,"loc":{"start":{"line":62,"column":134},"end":{"line":62,"column":142}}}) : helper)))
    + "\" "
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(lookupProperty(helpers,"find-in")||(depth0 && lookupProperty(depth0,"find-in"))||alias2).call(alias1,(depths[1] != null ? lookupProperty(depths[1],"suggestionChecks") : depths[1]),"suggestion_id",(depth0 != null ? lookupProperty(depth0,"suggestion_id") : depth0),{"name":"find-in","hash":{},"data":data,"loc":{"start":{"line":62,"column":150},"end":{"line":62,"column":209}}}),{"name":"if","hash":{},"fn":container.program(15, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":62,"column":144},"end":{"line":62,"column":225}}})) != null ? stack1 : "")
    + ">\n                <label class=\"text-break\" for=\"scb-"
    + alias4(((helper = (helper = lookupProperty(helpers,"suggestion_id") || (depth0 != null ? lookupProperty(depth0,"suggestion_id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"suggestion_id","hash":{},"data":data,"loc":{"start":{"line":63,"column":51},"end":{"line":63,"column":68}}}) : helper)))
    + "\">"
    + alias4(((helper = (helper = lookupProperty(helpers,"name") || (depth0 != null ? lookupProperty(depth0,"name") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data,"loc":{"start":{"line":63,"column":70},"end":{"line":63,"column":78}}}) : helper)))
    + "</label>\n            </div>\n";
  ...
  return "    <div class=\"d-flex justify-content-end\">\n    <button class=\"btn btn-primary fw-semibold\" type=\"submit\">"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"submit") || (depth0 != null ? lookupProperty(depth0,"submit") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"submit","hash":{},"data":data,"loc":{"start":{"line":74,"column":62},"end":{"line":74,"column":72}}}) : helper)))
    + "</button>\n    </div>\n";
  ...
  return "<form class=\"mb-4\" id=\"book-form\" action=\""
    ...
    + "</div>\n        </div>\n    </div>\n\n"
    + ((stack1 = lookupProperty(helpers,"unless").call(alias1,(depth0 != null ? lookupProperty(depth0,"omit_author") : depth0),{"name":"unless","hash":{},"fn":container.program(5, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":14,"column":4},"end":{"line":30,"column":15}}})) != null ? stack1 : "")
    + "\n    <div class=\"row mb-3\">\n        <label for=\"isbn-id\" class=\"col-form-label col-sm-3\">ISBN</label>\n        <div class=\"col input-group-has-validation\">\n            <input class=\"form-control "
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(lookupProperty(helpers,"error-check")||(depth0 && lookupProperty(depth0,"error-check"))||alias2).call(alias1,(depth0 != null ? lookupProperty(depth0,"trouble") : depth0),"isbn",{"name":"error-check","hash":{},"data":data,"loc":{"start":{"line":35,"column":45},"end":{"line":35,"column":73}}}),{"name":"if","hash":{},"fn":container.program(3, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":35,"column":39},"end":{"line":35,"column":92}}})) != null ? stack1 : "")
    ...
    + "\">\n            <div class=\"invalid-feedback\">"
    + alias3((lookupProperty(helpers,"error-check")||(depth0 && lookupProperty(depth0,"error-check"))||alias2).call(alias1,(depth0 != null ? lookupProperty(depth0,"trouble") : depth0),"isbn",{"name":"error-check","hash":{},"data":data,"loc":{"start":{"line":36,"column":42},"end":{"line":36,"column":72}}}))
    ...
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(lookupProperty(helpers,"error-check")||(depth0 && lookupProperty(depth0,"error-check"))||alias2).call(alias1,(depth0 != null ? lookupProperty(depth0,"trouble") : depth0),"summary",{"name":"error-check","hash":{},"data":data,"loc":{"start":{"line":43,"column":58},"end":{"line":43,"column":89}}}),{"name":"if","hash":{},"fn":container.program(3, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":43,"column":52},"end":{"line":43,"column":108}}})) != null ? stack1 : "")
    ...
    + alias3((lookupProperty(helpers,"error-check")||(depth0 && lookupProperty(depth0,"error-check"))||alias2).call(alias1,(depth0 != null ? lookupProperty(depth0,"trouble") : depth0),"summary",{"name":"error-check","hash":{},"data":data,"loc":{"start":{"line":44,"column":62},"end":{"line":44,"column":95}}}))
    + "</div>\n        </div>\n    </div>\n\n\n    "
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"condense") : depth0),{"name":"if","hash":{},"fn":container.program(11, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":49,"column":4},"end":{"line":49,"column":80}}})) != null ? stack1 : "")
    ...
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"suggestions") : depth0),{"name":"if","hash":{},"fn":container.program(13, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":56,"column":4},"end":{"line":68,"column":11}}})) != null ? stack1 : "")
    + "\n    "
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"condense") : depth0),{"name":"if","hash":{},"fn":container.program(17, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":70,"column":4},"end":{"line":70,"column":37}}})) != null ? stack1 : "")
    + "\n\n"
    + ((stack1 = lookupProperty(helpers,"if").call(alias1,(depth0 != null ? lookupProperty(depth0,"submit") : depth0),{"name":"if","hash":{},"fn":container.program(19, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":72,"column":4},"end":{"line":76,"column":11}}})) != null ? stack1 : "")
    + "</form>\n\n<script type=\"module\">\n\nimport {attachSummarizer} from '/attach-bookbot.js'\nimport {populateAuthorIds, populateGenreCheckboxes} from '/attach-tables.js'\n\nconst genreCheckList = [\n"
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,(depth0 != null ? lookupProperty(depth0,"genreChecks") : depth0),{"name":"each","hash":{},"fn":container.program(21, data, 0, blockParams, depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":85,"column":4},"end":{"line":87,"column":13}}})) != null ? stack1 : "")
    + "]\n\nattachSummarizer()\npopulateAuthorIds("
